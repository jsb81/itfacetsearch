...
{* Script per la ricerca dei progetti di partecipazione *}
{literal}
<script>
    var mapGlobal = null;
    ...
    $(document).ready(function(){
        ...
        function searchMapReload(){
            ...
            previousMapSearch = $.ajax({
                 "type": "GET",
                 "url": "https://"+siteURL+"/facetsearch/geo_search/" + class_identifier + "/" + facet_attributes +"/" + node_id,
                 ...
                 "success": function( result ){
                    ...
                    // North arrow
                    var north = L.control({position: "topright"});
                    north.onAdd = function(searchMap) {
                        var div = L.DomUtil.create("div", "info legend");
                        div.innerHTML = '<img src="/extension/itfacetsearch/design/standard/images/north-arrow.png" width=50 height=72 />';
                        return div;
                    };
                    north.addTo(searchMap);
